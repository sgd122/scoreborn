...
import CustomListMyChat from '../../components/ListItem/CustomListMyChat';
...
function MyChat({userStore, navigation}) {
    ...
    <Observer>
      {() => (
        <View style={[styles.container]}>
          <CustomListMyChat list={state.list} />
        </View>
      )}
    </Observer>
  );
...
export default inject('userStore')(({userStore, navigation}) => {
  return (
    <PageProvider>
      <MyChat userStore={userStore} navigation={navigation} />
    </PageProvider>
  );
});
